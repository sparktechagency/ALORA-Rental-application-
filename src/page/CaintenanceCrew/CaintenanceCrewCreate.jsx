...
const CaintenanceCrewCreate = () => {
    ...
    return (
        <div className="agent-create-container max-w-xl p-5"  >
            <Link to="/maintenance-crew" className="flex items-center gap-3 text-2xl font-semibold mb-4"><FaArrowLeft className='text-2xl' /> Create Maintenance Account</Link>
...
export default CaintenanceCrewCreate;
