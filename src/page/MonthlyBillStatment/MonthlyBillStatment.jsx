            ...
            <div className='flex justify-between items-center mb-4'>
                ...
                <div className="flex mb-4">
                    ...
                    <input
                        ...
                        className="p-2 min-w-[200px] border border-gray-300 rounded-md"
                    />
                </div>
            </div>

            {/* Table */}
            <table className="min-w-full table-auto p-3 shadow-sm !rounded-md overflow-hidden bg-white">
                ...
                <tbody>
                    {filteredData.map((item, index) => (
                        <tr key={item.id}>
                            ...
                            <Link to={`/monthly-bill-statement/${item.id}`} className="px-4 py-3 border flex items-center justify-center cursor-pointer">
                                <IoEyeOutline className='text-2xl' /></Link>
                        </tr>
                    ))}
                </tbody>
            </table>
